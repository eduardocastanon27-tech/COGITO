...
## Active threads
- **Cogito upgrade 2026-07** — playbook + COGITO-CORE + global install + Hermes wiring + eval. Detail: `docs/checkpoints/2026-07-03-cogito-upgrade.md`.
...
## Resume here (next)
1. Continue the Cogito upgrade phases (status + next step in its checkpoint).
